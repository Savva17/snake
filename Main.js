...
class Snake {
    ...
    draw() {
        ...
        this.auto = setInterval(() => {
            ...
            document.querySelector(".snake").classList.remove("snake");   // удаление головы змейки с поля

            document.querySelector(".x" + this.nextX + ".y" + this.nextY).classList.add("snake"); // добавление змейки на поле по кординатам
